...
local CreateClayShopGui = function()
	...
	-- createMenuButton(mainFrame, "closeButton", "Close Shop", UDim2.new(0, 0, 0, 0))
	-- createMenuButton(mainFrame, "buyButton", "Buy clay", UDim2.new(0.8, 0, 0, 0))
